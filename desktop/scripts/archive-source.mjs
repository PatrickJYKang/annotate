...
for (const file of candidates) {
  if (!/^(webapp\/|sidecar\/|desktop\/|scripts\/|docs\/|legacy\/|brand\/wordmark\/a-icon\.svg$|\.github\/|package(-lock)?\.json$|LICENSE$|README\.md$|USER_GUIDE\.md$|THIRD_PARTY_NOTICES\.md$|technical_document\.md$)/.test(file)) continue;
